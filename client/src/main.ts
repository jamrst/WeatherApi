...
const fetchWeather = async (cityName: string) => {
  ...
  //console.log('currentWeather: ', weatherData.weather.currentWeather);

  renderCurrentWeather(weatherData.weather.currentWeather);
  renderForecast(weatherData.weather.forecastArray);
};
...
const getAndRenderHistory = async () => {
  try {
    ...
    console.error('Failed to fetch and render search history:', error);
  }
};
